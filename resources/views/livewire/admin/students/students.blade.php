             ...
             <tbody>
                 @forelse ($students as $student)
                     <tr>
                         ...
                         <td>
                            <img alt="{{$student->name}}" src="{{$student->avatar_path}}" class="img-fluid img-thumbnail rounded-circle" style="max-width: 6rem">
                        </td>
                         <td>{{$student->name}}</td>
                         <td>{{$student->gen}}</td>
                         <td>{{$student->age}}</td>
                         <td>{{$student->email}}</td>
                         <td>{{$student->phone}}</td>
                         <td>{{$student->city ? $student->city->country->name : __('Deleted')}}</td>
