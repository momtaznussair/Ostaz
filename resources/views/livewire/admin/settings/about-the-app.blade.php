            ...
            <div class="main-profile-overview">
                ...
                <div class="form-group ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            @error('title') <div class="tx-danger mt-1"><strong>{{ $message }}</strong></div>
                            @enderror
                        </div>
                    </div>
                </div>
                <div class="form-group ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            @error('content') <div class="tx-danger mt-1"><strong>{{ $message }}</strong></div>
                            @enderror
                        </div>
                    </div>
                </div>
                <div class="row" x-data="{updated : false}">
                    <div class="col d-flex justify-content-end">
                        <span x-show="updated" x-transition.opacity.out.duration.1500ms class="tx-success mt-3"
